...
export type RPCType = {
	...
	addOrder: (name: string, price: number, bookings: Omit<Booking, "id" | "orderID">[], vouchers: Omit<Voucher, "id" | "code" | "valid" | "orderID">[], usedVouchers: number[]) => Promise<OrderResponse>;
